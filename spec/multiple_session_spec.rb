...
#    @@ph = slmc.ph_multiple_session(:case_type => "ORDINARY CASE", :case_rate_type => "SURGICAL",:case_rate => "RADIOTHERAPY",:session => "0", :compute => true)
    @@ph = slmc.ph_multiple_session(:case_type => "ORDINARY CASE", :case_rate_type => "SURGICAL",:case_rate => "77401",:case_rate_name => "RADIATION TREATMENT DELIVERY (LINEAR ACCELERATOR)",:session => "0", :compute => true)
    #fixed amount
