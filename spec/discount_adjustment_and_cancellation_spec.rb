...
describe "SLMC :: Discount - Adjustment and Cancellation Module" do
  ...
  before(:all) do
    ...
    @@doctor_dependent = "1411077964" #"1112100138"
...
#  end
  ...
  it "Patient3 - Compute and Save PhilHealth" do
    ...
    slmc.philhealth_computation(:claim_type => "ACCOUNTS RECEIVABLE", :diagnosis => "CHOLERA", :medical_case_type => "ORDINARY CASE", :compute => true, :rvu_code => "11444")
