...
describe "Patient Billing and Accounting - Additional Account Class Discount (Maternity & Employee)" do
  ...
  before(:all) do
    ...
    @password = "123qweuser"
    @employee = "1404069622" #"1301028146" #"1301027985" #1210127640" #"1301127954"#guarantor_code=>"0109995"  "
#    @maternity_employee = "1107007598"#guarantor_code=>"0109994"
    @maternity_employee =  "1404069623"      #"1301028151"#"1301127955"#guarantor_code=>"0109993"
    @gu_spec_user =  "gycapalungan"  #"gu_spec_user10"
    @pba_user = "ldcastro"  #"sel_pba15"
