...
describe "OSS SELECTIVE DISCOUNT (EMPLOYEE & HMO)" do
  ...
  before(:all) do
    ...
    @password = "123qweuser"
    @oss_user = "jtsalang"
    @selective_patient = "1410075936"#"1304029924" #SELENIUM_SELECTIVE,0824011
    @selective_patient2 = "1404070680" #SELENIUM_SELECTIVE_EM,0824013
    @drugs =  "049000075"
    @orders = {"010001662" => 1,
                        "010001525" => 1,
                        "010000007" => 1,
  ...
  it"OSS - HMO - Scenario 4 - Check Discount Table Information" do
      slmc.oss_discount_table.should == @fixed_discount1
  end
