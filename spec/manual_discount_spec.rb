...
#    @selenium_driver.evaluate_rooms_for_admission('0287','RCH08')
    @password = "123qweuser"
#    @password = "gohc"
      @employee = "1404070749"  # "1302028328"#guarantor_code=>"0109992"

#    @maternity_employee = "1001500418"#guarantor_code=>"0109991"
    @maternity_employee = "1404070752"  #"1302028332"#guarantor_code=>"0109991"
    #""
    #@employee_dependent = "1108008783"#benefactor_code=>"0109992" SELENIUM_TAN,SELENIUM_RACHEL
    @employee_dependent = "1404070757"

    @employee_dependent1 = "1404070753"#benefactor_code =>"0109995",SEL_EMPLOYEE,SELENIUM_RACHEL
    @employee1 = "1404070679"#"1404070760"#guarantor_code=>"0209992"
    @oss_employee = "1404070753"#"1302028333 "#SELENIUM_EMPLOYEE1
    @oss_maternity = "1404070753"#"1302028330"#SELENIUM_EMPLOYEE2
    @oss_dependent = "1404070753"#Sel_employee, Rachel Mae Cheng
...
###############=========================================================================================================================#
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Inpatient , If yr of service >= 1 AND Non-Maternity case - Create New Admission" do
  ...
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Inpatient , If yr of service >= 1 AND Non-Maternity case - Order Items" do
  ...
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Inpatient , If yr of service >= 1 AND Non-Maternity case - Clnically Discharge Patient" do
    slmc.nursing_gu_search(:pin=> @employee)
    @@visit_no = slmc.clinically_discharge_patient(:pin => @employee, :pf_amount => '1000', :no_pending_order => true, :save => true)
  end

  it"Account Class = Employee , Discount Type = Employee , Patient Type = Inpatient , If yr of service >= 1 AND Non-Maternity case - Philhealth" do
...
###################  it"Account Class = Employee , Discount Type = Employee , Patient Type = Inpatient , If yr of service >= 1 AND Non-Maternity case - Discount" do
###################    slmc.go_to_patient_billing_accounting_page
###################    slmc.pba_search(:with_discharge_notice => true, :pin => @employee)
...
###################  end
###
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Inpatient , If yr of service >= 1 AND Non-Maternity case - DAS Discharge" do
    slmc.go_to_patient_billing_accounting_page
    slmc.pba_search(:with_discharge_notice => true, :pin => @employee)
  ...
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Inpatient , If yr of service >= 1 AND Non-Maternity case - Check Discount Details" do
...
#
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Inpatient , If yr of service >= 1 AND Non-Maternity case - Print Gatepass" do
    slmc.login(@user, @password).should be_true
    slmc.nursing_gu_search(:pin => @employee)
...
################=========================================================================================================================#
################=========================================================================================================================#
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Outpatient , If yr of service >= 1 AND Non-Maternity case - Outpatient Order" do
  ...
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Outpatient , If yr of service >= 1 AND Non-Maternity case - Add Guarantor" do
    slmc.oss_add_guarantor(:guarantor_type =>  'EMPLOYEE', :acct_class => 'EMPLOYEE', :guarantor_code => "0109995", :guarantor_add => true)
  end

  it"Account Class = Employee , Discount Type = Employee , Patient Type = Outpatient , If yr of service >= 1 AND Non-Maternity case - Order Items" do
    slmc.oss_order(:order_add => true, :item_code => "010001194", :quantity => "1", :doctor => '0126')
  end

  it"Account Class = Employee , Discount Type = Employee , Patient Type = Outpatient , If yr of service >= 1 AND Non-Maternity case - Philhealth" do
  ...
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Outpatient , If yr of service >= 1 AND Non-Maternity case - Check Discount Details" do
  ...
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Outpatient , If yr of service < 1 OR Maternity case - Check Discount Details" do
    ...
    @@summary[:total_promo].to_f.should == @promo
    @@summary[:total_net_amount].to_f.should == @@summary[:total_gross_amount].to_f  - @total_charges
  end
################=========================================================================================================================#
################=========================================================================================================================#
################=========================================================================================================================#
...
################=========================================================================================================================#
  ...
  it"Account Class = Social Service , Discount Type = Courtesy , Patient Type = Outpatient - Check Discount applied" do
    ...
    @class_discount = @less_philhealth * 0.75
