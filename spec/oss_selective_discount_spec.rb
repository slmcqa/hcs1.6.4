...
#
    @package_discount = @package_discount.to_f
    puts "@package_discount -#{@package_discount}"
    puts "@package_discount_temp - #{@package_discount_temp}"
    ((slmc.truncate_to((@package_discount_temp - @package_discount),2).to_f).abs).should <= 0.00
