...
describe "SLMC :: Discounts - Outpatient" do
  ...
  before(:all) do
    ...
    @@doctor_dependent = "1411077964" # "1301028149" #"1211069307"
    @@board_member =  "1412078061"  #"1309047747"#1210168819" # "1112100137" existing BME patient - CABILI, LEONORA
...
#    sleep 6
##    slmc.add_pharmacy_patient(:pin =>"1011000002")
#    slmc.add_pharmacy_patient(:pin =>"1404069338")
...
#    @@courtesy_discount = slmc.compute_courtesy_discount(:fixed => true, :amount => @@courtesy_amount)
#    puts"@@courtesy_discount = #{@@courtesy_discount}"
#    @@class_discount2 = (((@@special_rate - (@@special_rate * (16.0/100.0))) * (25.0/100.0)) * 100 ).round.to_f / 100 ## Automatic 10% discount for DOCTOR DEPENDENTS applicable only for special items
